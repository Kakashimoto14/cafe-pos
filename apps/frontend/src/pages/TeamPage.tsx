...
export function TeamPage() {
  ...
  if (teamQuery.isLoading) {
    return <Card className="p-6 text-sm text-slate-500">Loading operator accounts...</Card>;
  }
  ...
  return (
    <div className="space-y-6">
      <section>
        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Access control</div>
        <h1 className="mt-3 font-display text-4xl text-slate-950">Team accounts</h1>
          ...
          <Card key={profile.id} className="p-5">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold text-slate-950">{profile.name}</h2>
